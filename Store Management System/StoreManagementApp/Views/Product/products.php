...
<body>
    <div class="container">
        ...
        <main>
            ...
            <form method="POST" action="<?php echo $basePath; ?>/product/deleteMultiple">
                <input type="text" id="search-input" placeholder="Search products...">
                <button id="add-product-btn" data-translate="add_product">Add Product</button>
                <button type="button" onclick="location.href='<?= $basePath; ?>/category/list'" data-translate>
                    Categories
                </button>
                <button type="submit" name="deleteSelected" id="delete-products-btn">Delete Selected Products</button>
                <br>
                <br>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <!--<a href="--><?php //= dirname($path) . "/product/view/" . $product->productId;  
                                                    ?><!--">View</a>-->
